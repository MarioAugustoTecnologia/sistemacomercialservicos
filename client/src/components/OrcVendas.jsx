  ...
  return (
    <div className="col p-0 m-0">
      ...
      <div className="px-5 mt-5" style={{fontFamily:'arial'}}>       
          ...
          <button type="button" onClick={Obs} className="btn btn-primary" style={{ width: 300, margin: '0 -130px', fontSize: '20px', fontFamily: 'arial'}}>Data e Formas de Pagamento:</button>
         <ToastContainer />  
