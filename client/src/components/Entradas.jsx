        ...
        <div className="col p-0 m-0" style={{ fontFamily: 'arial'}}>
          ...
          <div className="px-5 mt-5">
            <div className="mb3" style={{width:2000}}>
              ...
              <Link to="/entradas/nome" className="btn" style={{ color: 'white', backgroundColor: 'green', margin: '0 25px', fontSize: '18px', fontFamily: 'arial' }}>Faturamento por nome, mes e categoria:</Link>
