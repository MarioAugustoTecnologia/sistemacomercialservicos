      ...
      <div className="row flex-nowrap">
        ...
        <div className="col p-0 m-0" style={{ fontFamily: 'arial' }} >
          ...
          <div className="px-5 mt-5">
            <div className="mb3">
              <Link to="/cadnovascompras" className="btn btn-success" style={{ fontSize: '18px', fontFamily: 'arial' }}>Nova Compra:</Link>
              <Link to="/compras/nome" className="btn" style={{ color: 'white', backgroundColor: 'Orange', margin: '0 25px', fontSize: '18px', fontFamily: 'arial' }}>Despesa por nome:</Link>
              <Link to="/compras/data" className="btn" style={{ color: 'white', backgroundColor: 'yellowgreen', margin: '0 3px', fontSize: '18px', fontFamily: 'arial' }}>Despesa por data:</Link>
              <Link to="/compras/numero" className="btn" style={{ color: 'white', backgroundColor: 'DeepSkyBlue', margin: '0 25px', fontSize: '18px', fontFamily: 'arial' }}>Totalizar Compra:</Link>
              <Link to="/compras/mes" className="btn" style={{ color: 'white', backgroundColor: 'blue', margin: '0 5px', fontSize: '18px', fontFamily: 'arial' }}>Despesas por mês:</Link>
