            ...
            <div className='bg-white p-4 rounded border' style={{ width: '45%' }}>
              ...
              <form action='' onSubmit={cadastrar}>
                ...
                <div className='mb-3'>
                  ...
                  <select onSelect={MudaCorFor} style={{ fontWeight: 'bold', color: 'navy', fontSize: '20px', width: 420, margin: '0 115px' }} id='forname' className='form-select' onChange={(e) => setValues({ ...values, id: e.target.value })}>
                    <option></option>
                    {forname.map(val => {
