...
import CadServicos from './components/CadServicos';
import EntradasNumeroCat from './components/EntradasNumeroCat';
...
function App() { 
  ...
  return (  
    ...
    <Route path='/entradas/numero/categoria' element={<PrivateRoutes><EntradasNumeroCat/></PrivateRoutes>}></Route>
    ...
    <Route path='/servicos' element={<PrivateRoutes><CadServicos /></PrivateRoutes>}></Route> 
